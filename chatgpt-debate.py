...
try:
    ...
    if personality == "prof":
        ...
        system_prompt = {"role": "system", "content": "You are a 3-year old child who has just learned very basic English, debating with an adult. You know very little facts about the world. Your English is very simple and sometimes grammatically incorrect."}
